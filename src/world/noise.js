// Seeded random numbers and simplex noise (after Stefan Gustavson's public domain implementation).
...
// Deterministic integer hash of coordinates -> uint32.
...
export function hashFloat(seed, x, y, z) {
  return hash3(seed, x, y, z) / 4294967296;
}

// Turn any string into a 32-bit seed (like Minecraft's String.hashCode for text seeds).
